...
def main():
    ...
    sql = text("""
        ...
        GROUP BY c.client_id, c.name, cs.month_str
        ORDER BY c.name ASC, cs.month_str ASC
    """)
    
    with engine.begin() as conn:
        df = pd.read_sql(sql, conn)
        
    output_path = r"C:\Users\jakeb\OneDrive\Documents\GitHub\GoLive_Staffing\All_Clients_12_Month_Cancellations_By_Month.xlsx"
